...
% bin_filename = 'F:\\GOWIN\\TangMega-138KPro-example-main\\gowin_version_ip_introduction\\03_pwm\\sw\\pwm_motor\\build\\1c102_demo.bin';
% bin_filename = 'F:\\GOWIN\\TangMega-138KPro-example-main\\gowin_version_ip_introduction\\i2c_AT24CXX_plus\\build\\1c102_demo.bin';

mi_filename = '1c102_demo.mi'; % 输出run
% 调用函数转换二进制文件为mi格式  
data_depth=32768;
